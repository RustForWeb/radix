...
pub fn BorderBottomIcon(props: &BorderBottomIconProps) -> Html {
    ...
    html! {
        ...
        props.color}
            ...
            <rect x="13" y="3" width="1" height="1" rx=".5" fill={& props.color} />
            <rect x="7" y="7" width="1" height="1" rx=".5" fill={& props.color} />
        ...
        props.color}
            />
            <rect x="7" y="9" width="1" height="1" rx=".5" fill={& props.color} />
            <rect x="13" y="9" width="1" height="1" rx=".5" fill={& props.color} />
