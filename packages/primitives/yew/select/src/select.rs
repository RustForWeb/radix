        ...
        |_: (),
         (
            ...
            if let Some(trigger) = trigger_ref.cast::<web_sys::Element>()
                && let Some(value_node) = value_node_ref.cast::<web_sys::Element>()
                && let Some(content_wrapper) = content_wrapper_ref.cast::<web_sys::HtmlElement>()
                && let Some(content) = content_ref.cast::<web_sys::Element>()
                && let Some(viewport) = viewport_ref.cast::<web_sys::HtmlElement>()
                && let Some(selected_item) = selected_item
                && let Some(selected_item_text) = selected_item_text
            {
                let window = window().expect("Window should exist.");
                ...
                let item_text_rect = selected_item_text.get_bounding_client_rect();
                ...
                if *dir != Direction::Rtl {
                    ...
                    content_wrapper
                        .style()
                        .set_property("min-width", &format!("{min_content_width}px"))
                    ...
                    let right = window_inner_width - value_node_rect.right() - item_text_offset;
                    let right_delta = window_inner_width - trigger_rect.right() - right;
                ...
                let available_height = window_inner_height - CONTENT_MARGIN * 2.0;
                ...
                let content_border_bottom_width = content_styles
                    ...
                    .expect("Compyted style should have border bottom width.")
                    .trim_end_matches("px")
                    .parse::<f64>()
                ...
                let min_content_height =
                    (selected_item.offset_height() as f64 * 5.0).min(full_content_height);
                ...
                let item_offset_middle =
                    selected_item.offset_top() as f64 + selected_item_half_height;
                let content_top_to_item_middle =
                    content_border_top_width - content_padding_top + item_offset_middle;
                ...
                if will_align_without_top_overflow {
                    let is_last_item = !items.is_empty()
                        && items
                            ...
                            .r#ref
                            .cast::<web_sys::HtmlElement>()
                            .is_some_and(|element| &element == selected_item);
                ...
                content_wrapper
                    .style()
                    .set_property("margin", &format!("{CONTENT_MARGIN}px 0px"))
                    .expect("Margin should be set.");
                content_wrapper
                    .style()
                    .set_property("min-height", &format!("{min_content_height}px"))
